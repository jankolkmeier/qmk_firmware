...
const uint8_t recording_hue = 248;
const uint8_t reset_hue = 130;
...
[_BL] = LAYOUT( \
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,         KC_BSPC,  DYN_MACRO_PLAY1,  \
        KC_LGUI, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                   KC_ENT,  DYN_MACRO_PLAY2,  \
...
[_FL] = LAYOUT( \
    DYN_REC_STOP,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10, KC_F11, KC_F12,  KC_INS,  KC_DEL,  _______,  \
        _______, XXXXXXX, VVV_DFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SLCK, KC_BRK,  KC_UP,   XXXXXXX,          _______, DYN_REC_START1,  \
        _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_EJCT, XXXXXXX, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,                   KC_PENT, DYN_REC_START2,   \
...
uint32_t layer_state_set_user(uint32_t state) {
  ...
  if (isRecording) {
    vvv_smooth_set_target(layer_hue, recording_hue);
  } else {
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    case VVV_RST: // RESET THE KEYBOARD
      ...
      rgblight_sethsv_master(reset_hue, 235, 235);
